...
%TODO Tytuł po angielsku !
%TODO Dorobić abstrakt PL i EN oraz videoabstrakt (filmik prezentujący działanie poszczególnych metod)

%%TODO To trzeba wcześniej, bo tak Pan miesza. Proszę zacząć od segmantacji i wszystko na ten temat napisać, a później do FPGA. 
...
%%TODO proszę napisać co to są za obiekty
...
%%TODO Zacząłbym jednak od definicji co to jest, albo jak jest rozumiana sop.
...
%%TODO to jest niejasne, bo nie wiadomo do czego to się odnosi - wygląda jakby to uav.
...
%%TODO to trzeba odnieść do monitoringu wizyjnego i jakoś lepiej wkomponować.
...
Podczas procesu produkcji procesorów typu \textit{GPP} tranzystory są na stałe zatapiane w krzemie i nie ma możliwości późniejszej ingerencji w zaprojektowaną architekturę.  %%TODO Zatapiane to dobre słowo ? -- wydaje mi się, że tak
...
%%TODO to co Pan napisał jest dyskusyjne (chodzi o ten poziom ramki). Może proszę poruszyć wątek skali zrównoleglenia.  W procku ma Pan ~ 16 wątków czyli modułów obliczenowych. W FPGA dużo więcej. 

%%TODO a ten akapit to trochę nie pasuje - jakieś zdanie wprowadzenia jest potrzebne.
Projektowanie algorytmów do segmentacji obiektów pierwszoplanowych jest procesem dość złożonym i wieloetapowym. Często stosowane jest podejście, w którym dany algorytm w pierwszej kolejności zostaje zaimplementowany właśnie na standardowej, ogólnodostępnej platformie takiej jak komputer \textit{PC}. 
...
%%TODO to nie jest prawda ! jedno i drugie można ale używa dużo zasobów. Natomiast potokowo nie można algorytmów dla których sposób dostępu do danych zależy od treści.
...
%%TODO pomija Pan GPU - jakoś by się przydało odnieść

%%TODO i tu, że złożoność zagadnienia + opisane problemy i algorytmy wymagają platformy...
