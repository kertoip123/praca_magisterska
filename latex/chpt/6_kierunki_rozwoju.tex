...
%TODO a co Pana zdaniem dałaby ta dwuprzebiegowość ?
...
W przypadku rozszerzonych odmian algorytmów \textit{ViBE} oraz \textit{PBAS}, udało się jedynie zapewnić przetwarzanie w najniższej rozdzielczości.
...
Jak zostało już podkreślone jedną z blokad jest aktualnie dostępny sprzęt. %TODO raczej barier...
...
%TODO akurat oba były :) ale proste nie są... jak Pan wpisze bpp kryjak to Pan znajdzie takie moje artukuły na ten temat.
